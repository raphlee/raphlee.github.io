...
- In order to use AI, we need prompt, some kind of keyword that feed the AI to work. You can search prompts from [Lexica](https://lexica.art/), the Stable Diffusion search engine.
